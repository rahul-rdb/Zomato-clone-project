...
function NightlifeCardScroll(props) {
    ...
    <div className="card-block max-width">
      <div className="card-container">
        ...
        <div
          ...
          style={orderPlaced ? { display: "" } : { display: "none" }}
        ></div>

        <div
          className="card-order-wrapper flex absolute-center"
          style={orderPlaced ? { display: "" } : { display: "none" }}
        >
          <img
...
export default NightlifeCardScroll;
